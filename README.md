...
The `venndir` R package creates publication-ready Venn diagrams with
support for directionality, embedded item labels, and extensive options
for customization.
...
Explore the online book to learn how to design elegant set diagrams
using R.  
