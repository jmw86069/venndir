...
The `venndir` package creates Venn directional
diagrams that can display item labels inside the overlap regions.

![Venndir Book](docs/venndir-cover-10.png)
[Venndir Book](https://jmw86069.github.io/venndir-book/) -
The complete online guide to Venndir, also available in EPUB and
PDF formats.
